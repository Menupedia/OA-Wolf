...
// console.log(
//   '%c想看更多 OA Wu 的作品集嗎！？快看這裡喲！ %c➜ %chttp://www.ioa.tw/?f=works',
//   'color:rgba(36, 127, 84, 1.00);font-size:15px;line-height:25px;',
//   'color:rgba(213, 36, 35, 1.00);font-size:15px;line-height:25px;',
//   'color:rgba(66, 133, 244, 1.00);font-size:10px;line-height:25px;'
// );
